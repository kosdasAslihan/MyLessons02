...
public class Variables01 {
    public static void main(String[] args) {
        ...
        //System.out.println("ulkeNufusu = " + ulkeNufusu); ulkeNufusu.soutv ile de kisa yoldan etiketle yazdirabilirsiniz
        ...
        long c = 12, d = 13;
        System.out.println("Toplam : " + (c + d)); //25
        ...
        //çok hassas sonuçlar gerektiğinde, double'ın daha yüksek hassasiyeti faydalı olabilir. O yuzden default double dir.
        ...
        System.out.println("Toplam Fiyat : " + (corapFiyati + gomlekFiyati)); //38.98
